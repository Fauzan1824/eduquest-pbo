...
export default async function TambahMateriPage() {
  ...
  return (
    <div className="p-6 max-w-2xl mx-auto">
      ...
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-white">➕ Tambah Materi</h1>
        <p className="text-slate-400 mt-1">Isi form berikut untuk menambahkan materi baru.</p>
      </div>

      <MateriForm action={createMateri} submitLabel="Simpan Materi" />
    </div>
  );
}
